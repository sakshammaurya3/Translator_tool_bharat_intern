...
lab_txt=Label(root,text="Translator",font=("Times New Roman",40,"bold"),bg='white')
lab_txt.place(x=100,y=40,height=50,width=300)

frame = Frame(root).pack(side=BOTTOM)

lab_txt=Label(root,text="Source Text",font=("Times New Roman",20,"bold"),fg='Black',bg="green")
...
lab_txt=Label(root,text="Converted Text",font=("Times New Roman",20,"bold"),fg='Black',bg="green")
